  ...
  useEffect(() => {
    ...
    const addAIMetaTags = () => {
      const aiTags = [
        ...
        { name: 'ai:last_updated', content: '2026-04-29' },
        { name: 'ai:content_freshness', content: 'updated-2026' },
