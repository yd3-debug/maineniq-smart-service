      ...
      const voiceFAQSchema = {
        ...
        "mainEntity": [
          ...voiceQueries.map(query => ({
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": `Maineniq provides professional ${serviceName?.toLowerCase() || 'property maintenance'} services across London and 120-mile radius. We offer 24/7 emergency response, certified engineers, and 4.9-star rated service. Contact us on +44 (0) 189 55 28 226 for immediate assistance.`,
              "speakable": {
                "@type": "SpeakableSpecification",
