...
export const generateBMSServiceSchema = () => ({
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "BMS Maintenance & Optimisation London",
  "description": "Expert Building Management System maintenance and optimisation. Multi-platform certified engineers for Trend, Siemens, Honeywell, Johnson Controls. Reduce energy costs 15-30% with professional BMS servicing.",
  "url": "https://www.mainteniq.co.uk/building-management-systems-london",
  "image": "https://www.mainteniq.co.uk/og-image-mainteniq.png",
...
export const generateRenovationServiceSchema = () => ({
  ...
  "url": "https://www.mainteniq.co.uk/property-renovation-london",
