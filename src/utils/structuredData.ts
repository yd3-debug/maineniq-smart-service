export const generateOrganizationSchema = () => ({
  ...
  "description": "Award-winning professional HVAC maintenance and property services including FCU/HIU/MVHR servicing, BMS installation, smart home automation, plumbing, electrical, handyman & end-of-tenancy cleaning across London and the UK. 24/7 emergency response, certified engineers, 4.9 star rating.",
