          ...
          <div className="max-w-5xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 px-6 sm:px-0 overflow-hidden">
              <Link to="/contact" className="w-full sm:w-auto">
                <Button size="lg" variant="premium" className="w-full sm:w-auto text-xs sm:text-sm md:text-base font-medium px-3 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 min-h-[40px] sm:min-h-[44px] md:min-h-[56px] border-0">
                  <span className="lg:hidden">Get Free Assessment</span>
