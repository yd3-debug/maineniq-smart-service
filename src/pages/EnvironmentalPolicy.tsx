...
const EnvironmentalPolicy = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Environmental Policy | Mainteniq"
        description="Mainteniq's environmental commitments: F-Gas regulations compliance, waste reduction and energy-efficient maintenance practices."
